      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" menu="guru" href="<?= base_url('administrator/guru')?>">Data Guru</a>
            <a class="collapse-item" menu="jadwal_mengajar" href="<?= base_url('administrator/jadwal_mengajar')?>">Jadwal Mengajar</a>
            <a class="collapse-item" menu="siswa" href="<?= base_url('administrator/siswa')?>">Data Siswa</a>
            <a class="collapse-item" menu="kelas" href="<?= base_url('administrator/kelas')?>">Kelas</a>
            <a class="collapse-item" menu="jadwal_mapel" href="<?= base_url('administrator/jadwal_mapel')?>">Jadwal Pelajaran</a>
            <a class="collapse-item" menu="daftar_hadir" href="<?= base_url('administrator/daftar_hadir')?>">Daftar Hadir</a>
            <a class="collapse-item" menu="mapel" href="<?= base_url('administrator/mapel')?>">Mata Pelajaran</a>
          </div>
        </div>
      </li>
